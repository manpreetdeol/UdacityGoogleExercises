...
//        TestUtil.insertFakeData(mDb);
    ...
    public void addToWaitlist(View view) {
        ...
        if(partySize == null || guestName == null) {
            return;
        }
        ...
        try{
            partySizeInt = Integer.parseInt(partySize.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        addNewGuest(partySizeInt, guestName);
    ...
    void addNewGuest(int partySize, String guestName) {
