...
//    private static final String SEARCH_RESULTS_RAW_JSON = "results";
    ...
    private final int GITHUB_SEARCH_LOADER = 12;
...
//        Loader loader = loaderManager.getLoader(GITHUB_SEARCH_LOADER);
    ...
    private void makeGithubSearchQuery() {
        ...
        if(githubQuery == null || githubQuery.isEmpty())
            mErrorMessageDisplay.setText("Nothing to display");
...
//        new GithubQueryTask().execute(githubSearchUrl);
    ...
    private static class MyAsyncTaskLoader extends AsyncTaskLoader<String> {
        ...
        public String loadInBackground() {
            ...
            try {
                githubSearchResults = NetworkUtils.getResponseFromHttpUrl(new URL(queryUrl));
            } catch (IOException e) {
                e.printStackTrace();
            }
