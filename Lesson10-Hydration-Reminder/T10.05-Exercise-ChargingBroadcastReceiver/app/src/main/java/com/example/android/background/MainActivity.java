...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // when the chargingStatus state changes.
    ...
    /**
     * Updates the TextView to display the new chargingStatus reminder count from SharedPreferences
     */
    ...
    // when our broadcast receiver is triggered when the chargingStatus state changes.
    ...
    /**
     * This is a listener that will update the UI when the water count or chargingStatus reminder counts
     * change
     */
    @Override
    ...
    class ChargingBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            boolean chargingStatus= action.equals(Intent.ACTION_POWER_CONNECTED);

            showcharging(chargingStatus);
        }
    }
}